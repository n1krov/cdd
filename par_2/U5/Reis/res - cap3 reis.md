...
![Figura 3-1: La arquitectura de datos es un subconjunto de la arquitectura empresarial](f31%201.png)
...
![Figura 3-2: Arquitectura de datos operacional y técnica](f32%201.png)
...
![Figura 3-3: Dos dominios (ventas y contabilidad) comparten un servicio común (facturas)](f33%201.png)
...
![Figura 3-4: Un sistema distribuido horizontal simple utilizando una arquitectura líder-seguidor](f34%201.png)
...
1.  **Capa Única (Single Tier):** Base de datos y aplicación en el mismo servidor. Simple pero riesgosa para producción (si falla el servidor, falla todo). No recomendada para producción.
    ...
    ![Figura 3-5: Arquitectura de capa única](f35%201.png)
...
2.  **Multicapa (Multitier):** Separa datos, aplicación y lógica.
    ...
    *   **Shared-disk architecture:** Nodos comparten disco (útil para fallos de nodos).
    ...
    ![Figura 3-6: Una arquitectura de tres capas](f36%201.png)
...
![Figura 3-7: Una arquitectura extremadamente monolítica corre toda la funcionalidad dentro de una única base de código](f37%201.png)
...
![Figura 3-8: En un flujo de trabajo orientado a eventos, un evento es producido, enrutado y luego consumido](f38%201.png)

![Figura 3-9: En una arquitectura orientada a eventos, los eventos se pasan entre servicios débilmente acoplados](f39%201.png)
...
![Figura 3-10: Data warehouse básico con ETL](f310%201.png)
