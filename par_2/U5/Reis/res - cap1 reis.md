...
La ingeniería de datos ha emergido como un campo crucial, compartiendo protagonismo con la ciencia de datos. Es fundamental porque **construye los cimientos** para la ciencia de datos y la analítica en producción.

## ¿Qué es la Ingeniería de Datos?

El término "ingeniería de datos" ha sido históricamente confuso, abarcando desde análisis predictivo y descriptivo hasta informes. Su relevancia creció con el auge de la ciencia de datos en la década de 2010.

### Definición de Ingeniería de Datos (Según los autores)

Los autores sintetizan las definiciones en un patrón claro: un ingeniero de datos obtiene, almacena y prepara datos para su consumo.
...
Este es el concepto central del libro, alejando la conversación de la tecnología específica y centrándola en los datos y sus objetivos.

![Figura 1-1: El ciclo de vida de la ingeniería de datos](f11%205.png)
...
**Corrientes subyacentes (Undercurrents):** Seguridad, gestión de datos, DataOps, arquitectura de datos, orquestación e ingeniería de software.
...
> [!quote] Con respecto a este problema, Dan Ariely *twiteó*: *“Big data is like teenage sex: everyone talks about it, nobody really knows how to do it, everyone thinks everyone else is doing it, so everyone claims they are doing it.”*

![Figura 1-2: Tendencias de Google para "big data" (Marzo 2022)](f12%204.png)
...
![Figura 1-3: El paisaje de datos de Matt Turck en 2012 versus 2021](f13%204.png)
...
![Figura 1-4: La ingeniería de datos se sitúa aguas arriba de la ciencia de datos](f14%203.png)
...
![Figura 1-5: La Jerarquía de Necesidades de la Ciencia de Datos](f15%203.png)
...
![Figura 1-6: Un ingeniero de datos obtiene datos y proporciona valor a partir de ellos](f16%202.png)
...
![Figura 1-7: El acto de equilibrio de la ingeniería de datos](f17%202.png)
...
![Figura 1-8: Modelo simplificado de madurez de datos para una empresa](f18%202.png)
...
> [!note] **Ninguno es mejor que el otro.** De hecho, muchas veces es la misma persona en diferentes momentos.
> 
...
![Figura 1-9: Las direcciones que enfrenta un ingeniero de datos](f19%201.png)
...
- **De cara al exterior (External-facing):** Atiende a usuarios de aplicaciones externas (redes sociales, IoT, plataformas de e-commerce). Maneja alta concurrencia, límites de consultas y seguridad compleja (multitenencia).
  ...
  ![Figura 1-10: Sistemas de ingeniería de datos orientados al exterior](f110%201.png)
...
- **De cara al interior (Internal-facing):** Se enfoca en las necesidades del negocio y stakeholders internos (BI, dashboards, analistas).
  ...
  ![Figura 1-11: Ingeniero de datos orientado al interior](f111%201.png)

### Ingenieros de Datos y otros roles técnicos

![Figura 1-12: Stakeholders técnicos clave de la ingeniería de datos](f112%201.png)
...
> [!info] La diferencia principal radica en el **enfoque** y el **objetivo**:
>
