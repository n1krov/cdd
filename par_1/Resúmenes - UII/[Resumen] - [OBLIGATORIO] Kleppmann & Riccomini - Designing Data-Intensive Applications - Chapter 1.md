...
![Tabla 1-1. Comparando las características de los sistemas operacionales y analíticos.](img/kt1-1.png)
...
*   Los datos se mueven periódicamente desde todos los sistemas OLTP de la empresa hacia el Data Warehouse. Este proceso se llama **ETL (Extract, Transform, Load)**:
	...
	![Figura 1-1. Esquema simplificado del proceso ETL hacia un data warehouse.](img/kf1-1.png)
...
![Figura 1-2. Un espectro de tipos de software y sus operaciones.](img/kf1-2.png)
...
![Tabla 1-2. Ejemplos de sistemas de bases de datos auto-alojados y nativos de la nube.](img/kt1-2.png)
